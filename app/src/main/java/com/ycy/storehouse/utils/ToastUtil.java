...
public class ToastUtil {
    ...
    private static int yOffset = (int) (64 * BaseApp.getAppResources().getDisplayMetrics().density + 0.5);
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(BaseApp.getAppResources().getText(resId).toString(), duration);
    }

    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(BaseApp.getAppResources().getString(resId), args), duration);
    }
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = new Toast(BaseApp.getAppContext());
                sToast.setView(view);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        ...
        LayoutInflater inflate = (LayoutInflater) BaseApp.getAppContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
